...
export const metadata: Metadata = {
  title: "Chinonso Oken — Medical Doctor & Software Engineer",
  description:
    "Portfolio of Chinonso Oken — a medical doctor and senior full-stack software engineer building at the intersection of healthcare and technology.",
  keywords: [
    "medical doctor",
    "software engineer",
    "health tech",
